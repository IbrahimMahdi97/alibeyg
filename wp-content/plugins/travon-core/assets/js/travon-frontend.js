;(function($) {
      ...
      var GlobalJSLoad = function() {
        ...
        $.fn.shapeMockup = function () {
            ...
            $shape.each(function() {
              ...
              .parent().closest('section').addClass('shape-mockup-wrap');
            });
        };
    ...
    if ($('.hero-3').length > 0) {
        window.addEventListener('scroll', function() {
            ...
            $('.title-img').css('width',  177 - value * 0.3 + 'px' );
            var width = $(window).width();
            if (width < 992){
                $('.title-img').css('width',  150 - value * 0.3 + 'px' );
            }
        })
    };
    ...
    $('.category-box, .service-box, .service-grid, .counter-list').tilt({
        maxTilt: 20,
        perspective: 1000,   
    })
    ...
    var GlobalSlider = function() {
        ...
        $(".ot-carousel").each(function () {
            ...
            if (d("arrows") == true) {
                if (!otSlide.closest(".arrow-wrap").length) {
                    otSlide.closest(".container").parent().addClass("arrow-wrap");
                }
            }
            ...
            otSlide.not('.slick-initialized').slick({
        ...
        if ($(".testi-tab-menu").length > 0) {
            $(".testi-tab-menu").asTab({
                sliderTab: true,
                tabButton: ".tab-btn",
            });
        }
        ...
        $('#dealSlide2').not('.slick-initialized').slick({
            dots: false,
            infinite: true,
            speed: 1000,
            slidesToShow: 4,
    ...
    elementorFrontend.hooks.addAction('frontend/element_ready/travoncounterup.default',function($scope) {
        /*----------- 15. Counter Up ----------*/
