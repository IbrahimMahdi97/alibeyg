...
<div id="wp-travel-trip-wrapper" class="trip-content-area" itemscope itemtype="https://schema.org/ItemList">
    <div class="wp-travel-inner-wrapper">
        <div class="wp-travel-engine-archive-outer-wrapeee">
            <div class="destination-details">
                <?php
                    ...
                    <div class="page-header">
                        ...
                        <h2 class="h3 destination-title"><i class="fas fa-location-dot"></i><?php echo esc_html( $wte_trip_cat_name ); ?></h2>
                        <?php 
                        ...
                        if( isset($terms) && $terms!='' && is_array($terms) ) {
                            foreach( $terms as $t ) {
                                ...
                                if ($my_query->have_posts()) { ?>
                                    <h3 class="h4 mb-20"><?php echo esc_html($t->name);?></h3>
                                    <div class="wrap">
                                        ...
                                        <div class="row gy-30 category-main-wrap category-grid grid <?php echo esc_attr($t->term_id);?>" data-id="<?php echo esc_attr( $my_query->max_num_pages ); ?>">
                                            <?php
                                                ...
                                                if( $count > $default_posts_per_page ){
                                                    echo "<div class='load-destination' data-query-vars='".json_encode( $my_query->query_vars )."' data-current-page='".esc_attr( $paged )."' data-max-page='".esc_attr( $my_query->max_num_pages )."'><span class='ot-btn'>".__("Load More","travel-booking")."<i class='fa-duotone fa-loader ms-2'></i></span></div>";
                                                }
                                                wp_reset_postdata();
                                                wp_reset_query();
                                            ?>
