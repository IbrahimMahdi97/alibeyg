  ...
  */
  ...
  /*---------- 01. On Load Function ----------*/
   ...
   $(window).scroll(function () {
    ...
    $('.trip-content-area').addClass('space-top space-extra-bottom');


    if($('.custom-4-col .col-lg-4 col-md-6').hasClass('col-lg-4 col-md-6')){
        $('.custom-4-col .col-lg-4 col-md-6').removeClass('col-lg-4 col-md-6');
    }
    
    if($('.custom-4-col .used-js').hasClass('used-js')){
        $('.custom-4-col .used-js').addClass('col-xl-3 col-lg-4 col-md-6');
    }



    $('.ot-blog-carousel').slick({
        dots: false,
        infinite: true,
        arrows: true,
