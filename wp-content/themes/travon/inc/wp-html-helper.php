...
// image default alt
if( !function_exists( 'travon_img_default_alt' ) ){
	function travon_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'travon_img_tag' ) ){
	function travon_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = travon_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'travon_anchor_tag' ) ){
	function travon_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'travon_heading_tag' ) ){
	function travon_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'travon_paragraph_tag' ) ){
	function travon_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'travon_span_tag' ) ){
	function travon_span_tag( array $args ){
